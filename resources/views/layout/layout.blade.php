    ...
    <header class="mb-4">
        ...
        <div class="top-header py-2 bg-light">
            <div class="container d-flex justify-content-between">
                <div class="contact-info">
                    ...
                    <span class="text-dark  infos">|</span> <br>
                    <i class="fa fa-envelope tph-icons"></i> <span class="text-dark infos">agency@example.com</span>
                </div>
                <div class="user-actions align-items-center">
        ...
        <div class="main-header py-3 bg-white shadow">
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <nav class="navbar navbar-expand-lg justify-content-center text-center navbar-light  ml-auto mr-auto">
                        ...
                        <ul class="navbar-nav text-center">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="otherDropdown">
                                    <li><a class="dropdown-item" href="ErrorPage.html">Submenu 1</a></li>
                                    <li><a class="dropdown-item" href="ErrorPage.html">Submenu 2</a></li>
                                    <li><a class="dropdown-item" href="ErrorPage.html">Submenu 3</a></li>
                                </ul>
                            </li>
                ...
                <div class="d-flex ml-auto">
                    ...
                    <div class="cart text-right d-flex justify-content-end">
                        <a href="#"><i class="fa fa-shopping-cart" id="cart-btn"></i><span
                                class="badge rounded-pill badge-danger">3</span></a>
                    </div>

                    <div class="cart-view p-3 mr-5" id="cart-view">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5>Shopping Cart</h5>
                            <button class="close pb-2" id="close-cart-btn"><span
                                    aria-hidden="true">&times;</span></button>
                        </div>
                        <div class="cart-content container mt-3">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-7 align-items-center">
                                    <h6>Angular course 2020 mid guide</h6>
                        ...
                        <div class="d-flex justify-content-end mt-3">
                            <button class="LogINBtn" id="view-more-btn">Show Cart</button>
                        </div>
                    </div>
                    <!--MObile Menu-->
                    ...
                    <nav id="sidebar" class="sidebar">
                        ...
                        <ul class="list-unstyled components">
                            ...
                            <li class="MenuItem"><a href="courses"
                                    class="linkItem {{ request()->routeIs('courses') ? 'active' : '' }}">Courses</a>
                            </li>
